...
-- Schema Exercici7
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Exercici7` DEFAULT CHARACTER SET binary ;
USE `Exercici7` ;

-- -----------------------------------------------------
-- Table `Exercici7`.`Pasajero`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Exercici7`.`Pasajero` (
...
-- -----------------------------------------------------
-- Table `Exercici7`.`Avion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Exercici7`.`Avion` (
...
-- -----------------------------------------------------
-- Table `Exercici7`.`Vuelo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Exercici7`.`Vuelo` (
  ...
  CONSTRAINT `fk_Vuelo_Avion1`
    ...
    REFERENCES `Exercici7`.`Avion` (`idAvion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Exercici7`.`Reserva`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Exercici7`.`Reserva` (
  ...
  CONSTRAINT `fk_Reserva_Pasajero`
    ...
    REFERENCES `Exercici7`.`Pasajero` (`idPasajero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Reserva_Vuelo1`
    FOREIGN KEY (`Vuelo_idVuelo`)
    REFERENCES `Exercici7`.`Vuelo` (`idVuelo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Exercici7`.`Cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Exercici7`.`Cliente` (
  `id` INT NOT NULL,
  `Nombre` VARCHAR(45) NULL,
  `Apellidos` VARCHAR(45) NULL,
  `Telefono` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `Exercici7`.`Empleado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Exercici7`.`Empleado` (
  `id` INT NOT NULL,
  `Nombre` VARCHAR(45) NULL,
  `Apellidos` VARCHAR(45) NULL,
  `Direccion` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `Exercici7`.`Ticket` (
  ...
  CONSTRAINT `fk_Ticket_Cliente1`
    ...
    REFERENCES `Exercici7`.`Cliente` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Ticket_Empleado1`
    FOREIGN KEY (`Empleado_id`)
    REFERENCES `Exercici7`.`Empleado` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Exercici7`.`Producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Exercici7`.`Producto` (
  `id` INT NOT NULL,
  `Nombre` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `Exercici7`.`LineaTicket` (
  ...
  CONSTRAINT `fk_LineaTicket_Producto1`
    ...
    REFERENCES `Exercici7`.`Producto` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
